            ...
            <ScrollView>
                <Pressable
                    onPress={() => {
                        ...
                        .then(data => {
                            ...
                            else console.log(data.message); // Itt még ki kell valahol
                        })
                    }}
                >
                ...
                {workout.id ? (
                    ...
                    >
                        ...
                        <Pressable
                            onPress={() => {
                                fetch("http://localhost:4000/workout/infos/" + workout.name, { headers: { Authorization: token } })
                                .then(res => res.json())
                                .then(data => {
                        ...
                        >
                            <Ionicons name="information-circle-outline" color={Var.paleWhite} size={30}></Ionicons>
                        </Pressable>       
                    </View>
                ) : 
                    <TextInput 
